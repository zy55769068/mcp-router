...
const Settings: React.FC = () => {
  ...
  return (
    <div className="p-6 flex flex-col gap-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl">{t('settings.authentication')}</CardTitle>
        </CardHeader>
        <CardContent>
          {isAuthenticated ? (
              ...
              <div className="rounded-md bg-slate-100 dark:bg-slate-800 p-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <span className="font-medium">{userInfo?.name || userInfo?.userId}</span>
                  </div>
                  {/* Logout Button */}
                  <Button 
                    variant="outline" 
              ...
              <div className="rounded-md bg-slate-100 dark:bg-slate-800 p-4 space-y-3">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {isRefreshingCredits ? t('settings.refreshingCredits') : t('settings.refreshCredits')}
                    </Button>
                  </div>
                  <Badge variant="default" className="font-medium text-sm">
                    {(userInfo?.creditBalance || 0) + (userInfo?.paidCreditBalance || 0)} {t('settings.credits')}
                  </Badge>
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-3 border border-blue-200 dark:border-blue-800">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <Badge variant="outline" className="text-sm border-blue-300 text-blue-700 dark:text-blue-300">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            ...
            <Button 
              ...
              onClick={() => window.open('https://discord.gg/dwG9jPrhxB', '_blank')}
            >
