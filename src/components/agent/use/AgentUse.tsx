        ...
        const loadAgent = async () => {
            ...
            try {
                ...
                if (!agentData) {
                    ...
                    agentData = updatedStore.deployedAgents.find(agent => agent.id === id);
                }
        ...
        <div className="container h-full flex flex-col">
            ...
            <div className="flex justify-between items-start mb-3">
                <div className="max-w-[70%]">
                    ...
                    <p className="text-muted-foreground break-words">{agent.description}</p>
                </div>
            ...
            <Outlet context={{ agent }} key={`${agent.id}-${isSettingsPage ? 'settings' : 'chat'}`} />
