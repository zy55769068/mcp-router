    ...
    return (
      <div className="space-y-6">
        <div className="space-y-3">
          <Label htmlFor="remote-url" className="text-base font-medium flex items-center gap-1.5">
        ...
        <div className="space-y-3">
          <Label htmlFor="bearer-token" className="text-base font-medium flex items-center gap-1.5">
          ...
          <Input
            ...
            onChange={(e) => setEditedBearerToken && setEditedBearerToken(e.target.value)}
    ...
    <div className="space-y-6">
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <Server className="h-4 w-4 text-muted-foreground" />
          <h3 className="text-sm font-medium text-primary">{t('serverDetails.remoteUrl')}</h3>
        </div>
        <div className="pl-6">
          {server.remoteUrl ? (
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <Settings className="h-4 w-4 text-muted-foreground" />
          <h3 className="text-sm font-medium text-primary">{t('serverDetails.bearerToken')}</h3>
        </div>
        <div className="pl-6">
          {server.bearerToken ? (
            <div className="bg-muted p-3 rounded-md border shadow-sm">
